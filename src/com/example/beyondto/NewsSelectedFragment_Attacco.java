...
public class NewsSelectedFragment_Attacco extends Fragment {
	...
	public static NewsSelectedFragment_Attacco newInstance(int index) {

		NewsSelectedFragment_Attacco f = new NewsSelectedFragment_Attacco();
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		View rootView = inflater.inflate(R.layout.fragment_newsselected_attacco,
				container, false);
		
		//------------------- dynamic strings ----------------------//
  		String testo = "Qui compare la notifica relativa all'ATTACCO di questo edificio";
